...
const colorsMap = [
    { color: 'primary', category: 'INSS' },
    { color: 'secondary', category: 'FGTS' },
    { color: 'tertiary', category: 'Outro produto' },
];
const CalendarApp = () => {
    const htmlTitle = 'Calendário';
    const htmlDescription = 'Leads e clientes com eventos agendados.';
    ...
    const listEvents = async () => {
        await axios
            .get(`${BASE_URL}/data/v1/agenda-events`, configAxios)
            .then((res) => {
            ...
            <div className="d-flex justify-content-between">
                ...
                <Dropdown>
                    ...
                    >
                        ...
                        <Dropdown.Item
                            eventKey="timeGridDay"
                            active={selectedView === 'timeGridDay'}
