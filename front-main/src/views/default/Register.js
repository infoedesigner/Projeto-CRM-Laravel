    ...
    <div className="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
      <div className="sw-lg-50 px-5">
        ...
        <div className="mb-5">
          ...
          <h2 className="cta-1 text-primary">quer fazer parte de nossa rede?!</h2>
        </div>
        <div className="mb-5">
          <p className="h6">Por favor, informe seus dados de cadastro.</p>
          <p className="h6">
            Se já é amigo Carrera, por favor <NavLink to="/login">clique aqui</NavLink>.
          </p>
        </div>
        <div>
          <form id="registerForm" className="tooltip-end-bottom" onSubmit={handleSubmit}>
            <div className="mb-3 filled form-group tooltip-end-top">
              ...
              <Form.Control type="text" name="name" placeholder="Nome" value={values.name} onChange={handleChange} />
