...
const RegrasPortabilidadeListSave = (props) => {
        ...
        switch(tipo){
            case 9 : return <>
                <ul>
                    ...
                    <li className="text-danger">Bancos não portados: {item.bancos_nao_portados}</li>
                    <li className="text-primary">Bancos portados: {item.bancos_portados}</li>
                </ul>
            </>;
            case 4 : return <>
                <ul>
                ...
                <Col>
                    <div className="d-flex flex-column">
                        <div className="d-flex flex-column justify-content-center">
                            <h5><strong>{item.nome_banco} { item.regra }</strong></h5>
                        </div>
                        {
...
export default RegrasPortabilidadeListSave;
