...
const SettingsModal = ({ handleClose, show = false }) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title as="h5">Configurações</Modal.Title>
          <button type="button" className="btn-close" onClick={handleClose} />
        </Modal.Header>
        <Modal.Body>
          <OverlayScrollbarsComponent options={{ overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="scroll-track-visible">
            <OptionGroup label="Cor" noContainer>
              <>
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  ...
                  <OptionItem label="DARK AZUL" active={color === THEME_COLOR.DarkBlue} onClick={() => handleChange(settingsChangeColor, THEME_COLOR.DarkBlue)}>
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                ...
                <div className="row d-flex g-3 justify-content-between flex-wrap mb-3">
                  <OptionItem label="LIGHT VERMELHO" active={color === THEME_COLOR.LightRed} onClick={() => handleChange(settingsChangeColor, THEME_COLOR.LightRed)}>
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
                      <div className="red-light" />
                    </Card>
                  </OptionItem>
                  <OptionItem label="DARK VERMELHO" active={color === THEME_COLOR.DarkRed} onClick={() => handleChange(settingsChangeColor, THEME_COLOR.DarkRed)}>
                    <Card className="rounded-md p-3 mb-1 no-shadow color">
            ...
            <OptionGroup label="Cor da palheta">
              <>
                <OptionItem
                  label="DEFAULT"
                  className="w-33"
