            ...
            if (result.isConfirmed) {
                ...
                await axios.post(`${host}/edata/saveFinish`, values).then((response) => {
                    if (response.status === 200 && response.data.status === 'ok') {
                        ...
                        setTimeout(() => {
                            window.location.href = `/docs/${beneficio}/conta-benef/list`;
                        },2000);
                    }
                }).then(() => {
                    setIsLoading(false);
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-3 mt-2">
                                                        <div className="form-group">
                                                            <label>RG*</label>
                                                            <input className="form-control form-control-lg" name="rg"
                                                                   id="rg"
                                                    ...
                                                    <div className="col-3 mt-2">
                                                        ...
                                                        {formik.errors.orgao_emissor && (
                                                            <div className="text-danger">{formik.errors.orgao_emissor}</div>
                                                        )}
                                                    </div>
                                                    <div className="col-3 mt-2">
                                                        <div className="form-group">
                                                        ...
                                                        {formik.errors.nacionalidade && (
                                                            <div className="text-danger">{formik.errors.nacionalidade}</div>
                                                        )}
                                                    </div>
                                                    <div className="col-3 mt-2">
                                                        <div className="form-group">
                                                            <label>Gênero*</label>
                                                            <select className="form-select form-select-lg" name="genero"
                                                                    id="genero"
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-3 mt-2">
                                                        <div className="form-group">
                                                            <label>Conta</label>
                                                            <input className="form-control form-control-lg" name="conta_bancaria"
                                                                   id="conta_bancaria"
                                                ...
                                                <div className="row">
                                                    <div className="col-3 mt-2">
                                                        <div className="form-group">
                                                            <label>CEP</label>
                                                            <input className="form-control form-control-lg" name="cep"
                                                                   id="cep"
                                                    ...
                                                    <div className="col-2 mt-2">
                                                        <div className="form-group">
                                                            <label>UF</label>
                                                            <input className="form-control form-control-lg" name="uf"
                                                                   id="uf"
                                                ...
                                                <div className="row">
                                                    <div className="col-12 mt-2">
                                                        <div className="form-group">
                                                            ...
                                                            <input className="form-control form-control-lg" name="mae"
                                                                   id="mae"
                                                        ...
                                                        {formik.errors.mae && (
                                                            <div className="text-danger">{formik.errors.mae}</div>
                                                        )}
                                                    </div>
                                                    <div className="col-12 mt-2">
                                                        <div className="form-group">
                                                            <label>Nome do pai</label>
                                                            <input className="form-control form-control-lg" name="pai"
                                                                   id="pai"
                                                        ...
                                                        {formik.errors.pai && (
                                                            <div className="text-danger">{formik.errors.pai}</div>
                                                        )}
                                                    </div>
                                                </div>
                                                <div className="row">
