  ...
  return (
    <section className="wrapper bg-gray position-relative min-vh-60 d-lg-flex align-items-center">
      <div
        ...
        style={{ backgroundImage: 'url(/img/photos/bg38.png)' }}
      >
        ...
        <div className="row gx-0">
          <div className="col-lg-6 ms-auto">
            <div className="pt-13 pb-15 pb-md-17 py-lg-16 ps-lg-15 pe-xxl-16">
              <h2 className="fs-15 text-uppercase text-muted mb-3">Como funciona?</h2>
              <h3 className="display-3 ls-sm mb-7">Simule, escolha e pronto!</h3>
